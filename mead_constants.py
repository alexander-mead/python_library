...
# Cosmology
# Gravitational constant [(Msun/h)^-1 (km/s)^2 (Mpc/h)] ~4.301e-9 (1e3**2 m -> km)
G_cos = G*Sun_mass/(Mpc*1e3**2)
...
# Critical density [(Msun/h) (Mpc/h)^-3] ~2.775e11 (Msun/h)/(Mpc/h)^3
rhoc_cos = 3.*H0_cos**2/(8.*pi*G_cos)
# Neutrino mass required to close universe [eV]
nuconst = 93.1
